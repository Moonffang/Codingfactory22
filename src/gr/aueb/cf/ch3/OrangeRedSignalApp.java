...
/**
 * Ενα αεροσκαφος εχει δυο δεξαμενες. Αν μια δεξαμενη εχει λιγοτερο απο
 * 1/4 καυσιμα τοτε αναβει πορτοκαλι σημα, ενω αν και οι δυο δεξαμενες
 * εχουν < 1/4 τοτε αναβει κοκκινο σημα.
 *
 * Ο πιλοτος (χρηστης) δινει true η false αναλογα αν tank < 1/4 η οχι,
 * αντιστοιχα.
 */
